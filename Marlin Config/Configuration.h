...
#define STRING_CONFIG_H_AUTHOR "(G-Suresh)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  11.92   //gsuresh2u
    #define DEFAULT_Ki   0.95   //gsuresh2u
    #define DEFAULT_Kd  37.17   //gsuresh2u
  #endif
#endif
...
#define X_MIN_ENDSTOP_INVERTING true  //gsuresh2u // Set to true to invert the logic of the endstop.
...
#define X_MAX_ENDSTOP_INVERTING true  //gsuresh2u // Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 533.33, 533.33, 533.33, 322.12 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 25, 25, 5, 60 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -18, 0 }
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  //gsuresh2u
...
#define INVERT_X_DIR true   //gsuresh2u
#define INVERT_Y_DIR true
#define INVERT_Z_DIR true   //gsuresh2u
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION     //gsuresh2u
