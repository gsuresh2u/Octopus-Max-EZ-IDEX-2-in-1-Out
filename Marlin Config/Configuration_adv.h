...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS   120        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   620        // The max position of the X2 carriage, typically also the home position
 ...
 */
#define Z_STEPPER_AUTO_ALIGN    //gsuresh2u
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  50, 50 }, { 500,  50 }, { 500, 500 }, { 50, 500 } }
...
#define SET_PROGRESS_MANUALLY //gsuresh2u
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  //#define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction
  #define M73_REPORT         //gsuresh2u           // Report M73 values to host
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define AUTO_REPORT_SD_STATUS   //gsuresh2u      // Auto-report media status with 'M27 S<seconds>'
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //gsuresh2u LCD
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE  16   //gsuresh2u 8
...
#define TX_BUFFER_SIZE 64   //gsuresh2u0
...
#define SERIAL_FLOAT_PRECISION 4  //gsuresh2u
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES     //gsuresh2u      // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1272        // (mA) RMS current. Multiply by 1.414 for peak current.
 ...
 */
#define AUTO_REPORT_POSITION  //gsuresh2u
...
#define M114_DETAIL   //gsuresh2u      // Use 'M114` for details to check planner calculations
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   //gsuresh2u  // Report the new fan speed when changed by M106 (and others)
 ...
 */
#define HOST_ACTION_COMMANDS  //gsuresh2u
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT     //gsuresh2u      // Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS //gsuresh2u  // Send some status messages to the host as notifications
  #endif
